...
pub(crate) fn handle_get_info() -> Vec<u8> {
    let map = Value::Map(vec![
        (Value::Integer(1i64.into()), Value::Array(vec![Value::Text("FIDO_2_0".to_string())])),
        (Value::Integer(2i64.into()), Value::Array(vec![])),
        (Value::Integer(3i64.into()), Value::Bytes(crate::config::AAGUID.to_vec())),
        (Value::Integer(4i64.into()), Value::Map(vec![
